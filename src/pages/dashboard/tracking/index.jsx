...
const Tracking = () => {
    ...
    return (<>
        <div className="flex w-full  relative overflow-x-hidden">
            {<div className={`absolute bg-white h-[100vh] flex justify-start items-center flex-col pt-[20px] px-[30px] bg-opacity-30 -translate-x-0 ${!show && "-translate-x-[150%]"} z-40 transition duration-300 ease-in-out`}>
